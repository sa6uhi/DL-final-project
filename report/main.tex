...
The containerized FastAPI scoring service (single CPU worker, DAE-only
scoring) holds a steady-state resident footprint of approximately 310\,MiB
inside a 1.91\,GB uncompressed inference image.
