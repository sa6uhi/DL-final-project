...
is reported with the Exp-1 evaluation.
...
The trained DAE (485{,}440 parameters, 1.95\,MB checkpoint) was serialized to
both PyTorch EXIR (2.00\,MB) and ONNX (1.96\,MB) representations. Export-time
parity checks compare serialized outputs with their PyTorch reference
implementations. The FT-CAT and learned-gate checkpoints follow the same
export pipeline once their training lands.
