...
(Intel i7-12700H) with PyTorch CPU builds; the data split is strictly
...
\midrule
Logistic Regression (balanced) & 0.4354 & 0.8534 \\
Random Forest (200 trees, depth 16) & 0.4542 & 0.8743 \\
LightGBM (weighted) & 0.5089 & 0.8991 \\
\bottomrule
\end{tabular}
\end{table}
...
constrained model compresses to 56\,MB and scores the full validation split
...
were measured on a single-CPU container host (Intel i7-12700H) and are
